...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('permission:access-timesheets')->group(function () {
    ...
    // Read-only inventory routes (view access for all authenticated users)
    ...
    Route::get('/order/{Order}/certificates-zip', [DashboardController::class, 'DownloadOrderCertificatesZip'])->name('dashboard.order_certificates_zip');
    ...
    // Inventory write routes (Finance is read-only for these modules)
    Route::middleware('permission:modify-inventory')->group(function () {
        ...
        // Delete routes (Engineer & Warehouse Coordinator: no delete)
        Route::middleware('permission:delete-records')->group(function () {
    ...
    Route::middleware('permission:create-company')->group(function () {
    ...
    // company price lists (Engineer: no access)
    Route::middleware('permission:access-company-pricing')->group(function () {
