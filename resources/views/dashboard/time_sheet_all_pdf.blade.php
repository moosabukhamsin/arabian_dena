...
<head>
    ...
    <style>
        ...
        .titlebar { margin: 10px 0 8px 0; font-weight: 700; font-size: 11px; text-align: center; }

        table.sheet { width: 100%; border-collapse: collapse; table-layout: fixed; }
        table.sheet th, table.sheet td { border: 1px solid #C00000; padding: 3px 4px; word-wrap: break-word; overflow-wrap: break-word; }
        table.sheet thead th { background: #F4D45F; font-weight: 700; text-align: center; }
...
<body>
    ...
    <div class="titlebar">Time Sheet - All Order Items</div>
    ...
    <table class="sheet">
        <thead>
            <tr>
                ...
                <th style="width: 6%;">Backload Note</th>
                <th style="width: 6%;">Backload Date</th>
        ...
        <tbody>
            @foreach (($timesheetRows ?? []) as $row)
                <tr>
                    <td class="center">{{ $row['order_number'] }}</td>
